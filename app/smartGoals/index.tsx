...
export default function SmartGoalsScreen() {
    ...
    return (
      <SafeAreaView className="flex-1 bg-[#021A40]">
        <View className="flex-1 justify-center p-6">
          ...
          <View className="mb-8">
            <View className="bg-[#13203a] rounded-2xl p-6 shadow-lg border border-[#33CFFF]">
              <View className="mb-3">
  ...
  const renderGoal = (goal: any) => (
    <View key={goal.id} className="bg-[#13203a] rounded-2xl p-5 mb-4 shadow-lg border border-[#33CFFF]">
  ...
  const renderTimeframeSection = (timeframe: string, goals: any[]) => (
    <View key={timeframe} className="mb-8">
      ...
      {goals.length === 0 ? (
        <View className="bg-[#13203a] rounded-2xl p-8 items-center shadow-lg border border-[#33CFFF]">
